...
{{--Es una regla en todos los lenguajes que el foreach lleve un alias para el array--}}
            ...
            <div class="col-sm">
                <div class="card" style="width: 18rem; margin-top:30px;">
                    <center>
                        <img src="{{ Storage::url($do->img) }}" class="card-img-top" alt="..." style="width: 230px; height: 180px; margin: 10px"  >
                    </center>
                    <div class="card-body">

                        <li class="list-group-item">{{ $do->nombre }}</li>
                        <li class="list-group-item">{{ $do->apellido}}</li>


                    <br>
                    {{--Se necesita el id para ver un registro en particular--}}
                    <a href="/docente/{{$do->id}}" class="btn btn-dark" style="margin-left:75px">Ver más</a>
                </div>
            </div>
        </div>
